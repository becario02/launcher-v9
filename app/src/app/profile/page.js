                  ...
                  <div className="bg-white dark:bg-[#1C1C24] border border-gray-200 dark:border-[#2C2C38] rounded-2xl p-6 shadow-sm space-y-6">
                    ...
                    <div>
                      ...
                      <div className="text-[14px] font-medium font-poppins leading-[21px] text-[#171725] dark:text-[#f5f7fa]">
                        {loading ? 'Cargando...' : error ? 'Error al cargar los datos' : profileData?.fullname || 'N/A'}
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="text-[14px] font-medium font-poppins leading-[21px] text-[#171725] dark:text-[#f5f7fa]">
                        {loading ? 'Cargando...' : error ? 'Error al cargar los datos' : profileData?.email || 'N/A'}
                      </div>
                    </div>
                ...
                <div className="flex-1">
                  <div className="bg-white dark:bg-[#1C1C24] border border-gray-200 dark:border-[#2C2C38] rounded-2xl p-6 shadow-sm space-y-6">
                    ...
                    <div>
                      ...
                      <div className="text-[14px] font-medium font-poppins leading-[21px] text-[#171725] dark:text-[#f5f7fa]">
                        {loading ? 'Cargando...' : error ? 'Error al cargar los datos' : profileData?.profileName || 'N/A'}
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="text-[14px] font-medium font-poppins leading-[21px] text-[#171725] dark:text-[#f5f7fa]">
                        {loading ? 'Cargando...' : error ? 'Error al cargar los datos' : formatDate(profileData?.creationDate) || 'N/A'}
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="bg-white dark:bg-[#1C1C24] border border-gray-200 dark:border-[#2C2C38] rounded-2xl p-6 shadow-sm">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[14px] font-medium font-poppins leading-[21px] text-[#171725] dark:text-[#f5f7fa]">
                        {loading ? 'Cargando...' : error ? 'Error al cargar los datos' : formatDate(profileData?.lastLoginDate) || 'N/A'}
                      </span>
                      <Clock className="w-4 h-4 text-gray-500 dark:text-gray-400 ml-3" />
                      <span className="text-[14px] font-medium font-poppins leading-[21px] text-[#171725] dark:text-[#f5f7fa]">
                        {loading ? '' : error ? '' : formatTime(profileData?.lastLoginDate, true) || ''}
                      </span>
                    </div>
                  </div>
                </div>
