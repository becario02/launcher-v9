    ...
    <>
      ...
      >
        <div className="p-4 space-y-2">
          <button className="w-full flex items-center gap-3 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-[#2C2C38] px-3 py-2 rounded-lg transition">
