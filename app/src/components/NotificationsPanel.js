...
const notifications = [
  {
    id: 1,
    message: 'Lorem ipsum placerat mi tellus',
    time: 'Hace 23 min',
  },
  {
    id: 2,
    ...
    <section className="bg-white border border-gray-200 rounded-md p-4 h-full flex flex-col shadow-sm">
      ...
      <div className="overflow-y-auto max-h-[300px] pr-1">
        {notifications.map((n, index) => (
          <div key={n.id}>
            <div className="flex items-start gap-2 text-[11px] text-gray-700 bg-gray-100 px-3 py-2 rounded-md">
              <div className="w-2 h-2 mt-1 rounded-full bg-black shrink-0" />
